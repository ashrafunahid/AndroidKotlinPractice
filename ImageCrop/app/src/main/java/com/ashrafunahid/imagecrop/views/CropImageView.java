...
import com.ashrafunahid.imagecrop.callbacks.CropBoundsChangeListener;
import com.ashrafunahid.imagecrop.models.CropParameters;
import com.ashrafunahid.imagecrop.models.ImageState;
import com.ashrafunahid.imagecrop.tasks.BitmapCropTask;
import com.ashrafunahid.imagecrop.utils.CubicEasing;
...
public class CropImageView extends TransformImageView {
    ...
    protected void processStyledAttributes(@NonNull TypedArray a) {
        float targetAspectRatioX = Math.abs(a.getFloat(R.styleable.ncrop_ncropView_ncrop_aspect_ratio_x, DEFAULT_ASPECT_RATIO));
        float targetAspectRatioY = Math.abs(a.getFloat(R.styleable.ncrop_ncropView_ncrop_aspect_ratio_y, DEFAULT_ASPECT_RATIO));
