...
public class NCropView extends FrameLayout {

    private GestureCropImageView mGestureCropImageView;
    private final OverlayView mViewOverlay;

    public NCropView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NCropView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ncrop_ncropView);
