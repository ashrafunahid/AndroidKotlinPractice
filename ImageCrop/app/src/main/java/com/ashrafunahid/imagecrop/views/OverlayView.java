package com.ashrafunahid.imagecrop.views;
...
import com.ashrafunahid.imagecrop.callbacks.OverlayViewChangeListener;
import com.ashrafunahid.imagecrop.utils.RectUtils;
...
//        }
    ...
    protected void processStyledAttributes(@NonNull TypedArray a) {
        mCircleDimmedLayer = a.getBoolean(R.styleable.ncrop_ncropView_ncrop_circle_dimmed_layer, DEFAULT_CIRCLE_DIMMED_LAYER);
        mDimmedColor = a.getColor(R.styleable.ncrop_ncropView_ncrop_dimmed_color,
                getResources().getColor(R.color.color_default_dimmed));
        ...
        mShowCropFrame = a.getBoolean(R.styleable.ncrop_ncropView_ncrop_show_frame, DEFAULT_SHOW_CROP_FRAME);

        initCropGridStyle(a);
        mShowCropGrid = a.getBoolean(R.styleable.ncrop_ncropView_ncrop_show_grid, DEFAULT_SHOW_CROP_GRID);
    }
    ...
    private void initCropFrameStyle(@NonNull TypedArray a) {
        int cropFrameStrokeSize = a.getDimensionPixelSize(R.styleable.ncrop_ncropView_ncrop_frame_stroke_size,
                getResources().getDimensionPixelSize(R.dimen.default_crop_frame_stoke_width));
        int cropFrameColor = a.getColor(R.styleable.ncrop_ncropView_ncrop_frame_color,
                getResources().getColor(R.color.color_default_crop_frame));
    ...
    private void initCropGridStyle(@NonNull TypedArray a) {
        int cropGridStrokeSize = a.getDimensionPixelSize(R.styleable.ncrop_ncropView_ncrop_grid_stroke_size,
                getResources().getDimensionPixelSize(R.dimen.default_crop_grid_stoke_width));
        int cropGridColor = a.getColor(R.styleable.ncrop_ncropView_ncrop_grid_color,
        ...
        mCropGridRowCount = a.getInt(R.styleable.ncrop_ncropView_ncrop_grid_row_count, DEFAULT_CROP_GRID_ROW_COUNT);
        mCropGridColumnCount = a.getInt(R.styleable.ncrop_ncropView_ncrop_grid_column_count, DEFAULT_CROP_GRID_COLUMN_COUNT);
    }
