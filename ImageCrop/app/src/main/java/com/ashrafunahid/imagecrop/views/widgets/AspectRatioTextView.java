package com.ashrafunahid.imagecrop.views.widgets;
...
public class AspectRatioTextView extends AppCompatTextView {
    ...
    public AspectRatioTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ncrop_AspectRatioTextView);
        init(a);
    }
    ...
    private void init(@NonNull TypedArray a) {
        ...
        mAspectRatioTitle = a.getString(R.styleable.ncrop_AspectRatioTextView_ncrop_artv_ratio_title);
        mAspectRatioX = a.getFloat(R.styleable.ncrop_AspectRatioTextView_ncrop_artv_ratio_x, CropImageView.SOURCE_IMAGE_ASPECT_RATIO);
        mAspectRatioY = a.getFloat(R.styleable.ncrop_AspectRatioTextView_ncrop_artv_ratio_y, CropImageView.SOURCE_IMAGE_ASPECT_RATIO);
        ...
        mDotSize = getContext().getResources().getDimensionPixelSize(R.dimen.size_dot_scale_text_view);
        mDotPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mDotPaint.setStyle(Paint.Style.FILL);

        setTitle();

        int activeColor = getResources().getColor(R.color.color_widget_active);
        applyActiveColor(activeColor);
    ...
    private void applyActiveColor(@ColorInt int activeColor) {
        ...
        ColorStateList textViewColorStateList = new ColorStateList(
                ...
                new int[]{
                        activeColor,
                        ContextCompat.getColor(getContext(), R.color.color_widget)
                }
        );
